...
1. **`cc-window` Claude Code 终端 UI 体系** — 19-tips 12/21 章用过，含 5 种 body 变体（prompt-line / agent-call / question / bullets / typing）+ 5 段 statusline。**最高复用价值**，应抽到 `templates/components/` 或 catalog block。
