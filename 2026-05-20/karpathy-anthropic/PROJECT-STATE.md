...
| seg03 | ch3 momentum | 3:50 | 5:21 | 91s | 72-103 | A 社采纳率 0.003%→7.94%→34.4% + 5.4 联手黑石/高盛 | cutaway | 🟢 v1 用户确认 + lint/validate + thumbnail 自审 | — |
| seg04 | ch4 wrapper | 5:21 | 8:42 | 201s | 104-177 | 套壳从贬义到产品 + 洋葱图 + 主持稿例子 | cutaway | 🟡 PLAN 就绪待审 | — |
