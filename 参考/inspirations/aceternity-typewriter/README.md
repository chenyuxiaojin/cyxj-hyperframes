...
## 5. 如何晋级到 组件库/typewriter/

1. `mkdir 组件库/typewriter/`
...
4. `index.html` 里 `GSAP timeline START → END` 段作为 `组件库/typewriter/README.md` 的"动画时序参考"。用户在 composition 里嵌时调用 `play()` 即可
5. 给 `组件库/typewriter/` 写 README 说明：
